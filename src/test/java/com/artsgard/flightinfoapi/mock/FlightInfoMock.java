...
public final class FlightInfoMock {
    ...
    public static FlightInfo generateFlightInfo() {
        FlightInfo flight = new FlightInfo(null, "faFlightId", "ident", "aircraftType", "filedEte", 1223L, 1234L,
    ...
    public static List<FlightInfo> generateFlights() {
        ...
        FlightInfo flight2 = new FlightInfo(null, "faFlightId2", "ident2", "aircraftType2", "filedEte2", 12232L, 12342L,
        ...
        FlightInfo flight3 = new FlightInfo(null, "faFlightId3", "ident3", "aircraftType3", "filedEte3", 12233L, 12343L,
